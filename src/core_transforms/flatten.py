...
if __name__ == "__main__":
    with beam.Pipeline() as p:
        ...
        hr_team = input_employees | "Filter HR Employees" >> beam.Filter(
            lambda emp: emp["department"] == "HR"
        )

        engineering_team = input_employees | "Filter Engineering Employees" >> beam.Filter(
